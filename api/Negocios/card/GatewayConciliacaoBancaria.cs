                                                                   ...
                                                                   List<ConciliacaoBancaria> listaNaoConciliado)
        {
            foreach (var item in listaNaoConciliado)
            {
                listaConciliacao.Add(new
                {
                    ...
                    AdquirenteRecebimento = item.Tipo != TIPO_RECEBIMENTO ? null : item.Adquirente,
                    AdquirenteExtrato = item.Tipo != TIPO_EXTRATO ? null : item.Adquirente,
                                                     ...
                                                     TIPO_CONCILIADO tipo)
        {
            if (recebimento != null && movimentacao != null)
            {
                ...
                listaConciliacao.Add(new
                {
                    ...
                    AdquirenteRecebimento = recebimento.Adquirente,
                    AdquirenteExtrato = movimentacao.Adquirente,
                    ...
                    ValorTotalBruto = recebimento.ValorTotalBruto != null ? recebimento.ValorTotalBruto.Value : new decimal(0.0),
