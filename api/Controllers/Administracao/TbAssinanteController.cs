...
{
    public class TbAssinanteController : ApiController
    {

        // GET /tbAssinante/token/colecao/campo/orderBy/pageSize/pageNumber?CAMPO1=VALOR&CAMPO2=VALOR
        public HttpResponseMessage Get(string token, int colecao = 0, int campo = 0, int orderBy = 0, int pageSize = 0, int pageNumber = 0)
        {
            ...
            try
            {
                ...
                {
                    Retorno dados = GatewayTbAssinante.Get(token, colecao, campo, orderBy, pageSize, pageNumber, queryString);
        ...
        // PUT /tbAssinante/token/
        public HttpResponseMessage Put(string token, [FromBody]List<Assinante> param)
        {
            tbLogAcessoUsuario log = new tbLogAcessoUsuario();
            try
            {
                ...
                if (Permissoes.Autenticado(token))
                {
                    GatewayTbAssinante.Update(token, param);
                    log.codResposta = (int)HttpStatusCode.OK;
                    Bibliotecas.LogAcaoUsuario.Save(log);
