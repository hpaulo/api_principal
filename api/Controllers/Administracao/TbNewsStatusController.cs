...
{
    public class TbNewsStatusController : ApiController
    {
    
        // GET /tbNewsStatus/token/colecao/campo/orderBy/pageSize/pageNumber?CAMPO1=VALOR&CAMPO2=VALOR
        ...
        // POST /tbNewsStatus/token/
        public HttpResponseMessage Post(string token, [FromBody]tbNewsStatus param)
        {
            tbLogAcessoUsuario log = new tbLogAcessoUsuario();
            try
            {
        ...
        // DELETE /tbNewsStatus/token/idNews
        public HttpResponseMessage Delete(string token, Int32 idNews)
        {
            tbLogAcessoUsuario log = new tbLogAcessoUsuario();
            try
            {
                log = Bibliotecas.LogAcaoUsuario.New(token, JsonConvert.SerializeObject("idNews : " + idNews), "Delete");
