...
{
    public class LogCbSuperFamiliaMap : EntityTypeConfiguration<LogCbSuperFamilia>
    {
        public LogCbSuperFamiliaMap()
        {
            // Primary Key
            this.HasKey(t => new { t.cod_sit, t.data_sitef, t.nsu_sitef, t.codlojasitef, t.cod_trnweb });
            ...
            this.ToTable("LogCbSuperFamilia");
